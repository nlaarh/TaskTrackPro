            ...
            {selectedQuote && (
              <Tabs defaultValue="details" className="w-full">
                ...
                <TabsContent value="details" className="space-y-6 mt-6">
                  ...
                  {/* Additional Notes */}
                  {(selectedQuote.additional_notes || selectedQuote.allergies) && (
                    <Card>
                      <CardHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="assignedFlorist">Assign Florist</Label>
                          <Select
                            value={assignedFloristId?.toString() || ""}
                            onValueChange={(value) => setAssignedFloristId(value ? parseInt(value) : null)}
                          >
                            <SelectTrigger>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      {selectedQuote.admin_notes && (
                        <div>
                          <Label className="text-sm text-gray-500">Current Notes</Label>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="adminNotes">Add/Update Notes</Label>
                        <Textarea
                          id="adminNotes"
                      ...
                      <div className="flex gap-2 pt-4">
                        <Button onClick={handleUpdateQuote} disabled={updateQuoteMutation.isPending}>
                          {updateQuoteMutation.isPending ? 'Updating...' : 'Update Quote Request'}
                        </Button>
